...
describe("buildActivityNotifications", () => {
  it("orders incomplete overdue, today, and upcoming activities", () => {
    const notifications = buildActivityNotifications(
      [
        { ...baseActivity, id: "upcoming", tanggal: "2026-05-26", waktu: "09:00" },
        { ...baseActivity, id: "done", tanggal: "2026-05-25", waktu: "09:00", status: "Selesai" },
        { ...baseActivity, id: "today", tanggal: "2026-05-25", waktu: "10:00" },
        { ...baseActivity, id: "overdue", tanggal: "2026-05-20", waktu: "08:00" },
      ],
